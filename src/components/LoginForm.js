      ...
      <form onSubmit={handleLogin}>
        <div className="mb-6">
          ...
          <div className="relative">
            <i className="fas fa-envelope absolute left-4 top-1/2 -translate-y-1/2 text-gray-500" />
            <input
              type="email"
              id="email"
              value={email}
              onChange={(e) => setEmail(e.target.value)}
              className="w-full pl-10 pr-4 py-3 border border-blue-200 rounded-md focus:outline-none focus:border-blue-600 focus:ring-3 focus:ring-blue-600/10"
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <i className="fas fa-lock absolute left-4 top-1/2 -translate-y-1/2 text-gray-500" />
            <input
              type="password"
              id="password"
              value={password}
        ...
        <button
          type="submit"
          className="w-full py-3 bg-gradient-to-r from-blue-900 to-blue-600 text-white rounded-md font-medium hover:from-blue-800 hover:to-blue-900 transform hover:-translate-y-0.5 transition-all active:translate-y-0"
        >
          Log In
        </button>
      </form>
